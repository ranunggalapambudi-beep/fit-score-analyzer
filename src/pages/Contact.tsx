...
import { ArrowLeft, Send, Mail, MapPin, Phone, Loader2, CheckCircle, Instagram } from "lucide-react";
      ...
      <main className="flex-1 overflow-auto">
        <div className="p-4 space-y-6 pb-24">
          ...
          <div className="grid grid-cols-1 gap-3">
            <a href="mailto:hiro.cross1010@gmail.com" className="flex items-center gap-3 p-3 rounded-lg bg-card border border-border/50 hover:border-primary/50 transition-colors">
              <div className="w-10 h-10 rounded-lg bg-primary/10 flex items-center justify-center">
                <Mail className="w-5 h-5 text-primary" />
              </div>
              <div>
                <p className="text-xs text-muted-foreground">Email</p>
                <p className="text-sm font-medium">hiro.cross1010@gmail.com</p>
              </div>
            </a>
            <a href="https://instagram.com/hirocros" target="_blank" rel="noopener noreferrer" className="flex items-center gap-3 p-3 rounded-lg bg-card border border-border/50 hover:border-primary/50 transition-colors">
              <div className="w-10 h-10 rounded-lg bg-primary/10 flex items-center justify-center">
                <Instagram className="w-5 h-5 text-primary" />
              </div>
              <div>
                <p className="text-xs text-muted-foreground">Instagram</p>
                <p className="text-sm font-medium">@hirocros</p>
              </div>
            </a>
