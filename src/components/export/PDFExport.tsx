  ...
  return (
    <>
      ...
      >
        ...
        {analysisResult && (
          <div className="mb-6">
            <h2 className="text-lg font-bold text-gray-900 mb-3">Analisis AI</h2>
            
            <div className="grid grid-cols-2 gap-4 mb-4">
              <div className="bg-green-50 rounded-lg p-4">
                <h3 className="font-semibold text-green-800 mb-2">Kekuatan</h3>
              ...
              <div className="bg-red-50 rounded-lg p-4">
                <h3 className="font-semibold text-red-800 mb-2">Area Pengembangan</h3>
            ...
            <div className="bg-blue-50 rounded-lg p-4 mb-4">
              <h3 className="font-semibold text-blue-800 mb-2">Rekomendasi Latihan</h3>
            ...
            <div className="bg-gray-50 rounded-lg p-4">
              <h3 className="font-semibold text-gray-800 mb-2">Kesimpulan</h3>
